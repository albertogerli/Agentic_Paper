...
End your review with: "REVIEW COMPLETED - Ethics & Integrity Reviewer" """,
    ...
    def create_ai_origin_agent(self) -> Agent:
        return Agent(
            name="AI_Origin_Detector",
            instructions="""You are an expert in detecting whether a scientific paper was written with the aid of artificial intelligence tools.\nYour analysis should focus on:\n1. Stylistic patterns typical of AI-generated text (repetitiveness, unnatural phrasing, lack of domain-specific nuance).\n2. Inconsistencies in terminology or tone that might indicate automated generation.\n3. Presence of factual errors or hallucinations common in large language model outputs.\n4. Abrupt topic shifts or overly generic statements.\n5. Any metadata or formatting clues suggesting AI assistance.\n\nProvide a reasoned assessment IN ENGLISH stating the likelihood that the paper was at least partially generated by AI.\nCite specific evidence from the text where possible.\n\nEnd your review with: "REVIEW COMPLETED - AI Origin Detector""",
            model=self.config.model_basic,
...
End with: "EDITORIAL DECISION COMPLETED" """,
    ...
    def create_all_agents(self) -> Dict[str, Agent]:
        ...
        return {
            ...
            "ai_origin": self.create_ai_origin_agent(),
...
8. **AI Origin Detector**: Evaluated whether the text shows signs of AI generation
